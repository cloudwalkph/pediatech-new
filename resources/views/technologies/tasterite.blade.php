            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 tech-content">
                    <div class="text-center">
                        <h1><img src="/img/tasterite-logo.png" alt="Suredose" height="40"></h1>
                        <span><b style="color:#696969;">The Problem of Bad Taste</b></span>
                        <p>Pediatric medications are most commonly formulated in liquid preparations such as syrups and suspensions. Liquid medicines are ideal for children because dose can be adjusted according to the weight of the child. Liquid medicines are also easier to drink for kids who may have trouble swallowing tablets or capsules. However, liquid medicines often taste bad.</p>
                        <p>Bad taste is a big reason why children resist taking medicines, leading to incomplete or worse, missed doses. 73% of US parents (1998 US survey, among 500 parents), 77% of Philippine mothers (2002 Philippine survey, among 110 mothers), and 9/10 doctors (American Academy of Pediatric Periodic survey #44, Jan-May 2000, among 803 pediatricians) say that bad taste is a major cause of poor compliance.</p>
                        <span><b style="color:#696969;">TasteRite Technology</b></span>
                        <p>TasteRite is the world’s only non-flavor based pediatric taste-masking patented technology. It is a unique taste-masking system that can be applied to various liquid medicine formats in order to significantly reduce the bitterness of medicine. Thus, making the lives of children and parents easier.</p>
                        <p>TasteRite utilizes a polymer system that prevents the interaction of the bad-tasting drug particles and the taste receptors on the tongue, resulting in a better tasting liquid medicine. This polymer system rapidly releases the drug in the stomach, allowing the drug to rapidly dissolve for easy absorption (US patent: US 7,107,572 B2).</p>
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <p style="text-align: center; color:#696969; font-size: 18px;"><b>Products using the TasteRite Technology</b></br>
