            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 tech-content">
                    <div class="text-center">
                        <h1><img src="/img/zinc-plus-logo.png" alt="Zincplus" height="40"></h1>
                        <span><b style="color:#696969;">Vitamin C and Zinc Immunity Combination</b></span>
                        <p>The immune system effectively defends the body against attacks by “foreign” invaders. However, there are moments when the immune system weakens and fails to keep disease-causing microorganisms out. In light of this, the immune system can always use a boost.</p>
                        <p>Vitamin C and zinc is the ideal combination to enhance and balance innate immunity and adaptive immunity for optimal immune protection. Studies have shown that they significantly reduce the symptoms of the common cold.</p>
                        ...
                        <p>ZincPlus is a patented technology that powers world’s only stable formulation of Vitamin C and Zinc in liquid format. It uses unique polymer strands that prevent the degradation of vitamin C (Fig. 2). It also reduces the metallic taste and astringency of zinc (Fig. 3). Watch the video below for more on PediaTech’s ZincPlus technology.</p>
                    ...
                    <div class="col-md-12 text-center video">
                        ...
                        <p style="text-align: center; color:#696969; font-size: 18px;"><b>ZincPlus in the Real World</b></br>
